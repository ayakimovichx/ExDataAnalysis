...
image3<-qplot(x=year, y=Total.Emissions, data=data3, facets=.~type, geom="line", colour=type,
      main="Emissions in Baltimore by type, 1999-2008", xlab="Year", ylab="PM2.5 emissions, tons")
